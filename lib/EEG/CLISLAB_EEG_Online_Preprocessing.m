...
%% Giovanni reshaping output start

if (isfield(preprocessedBaselineData,'eeg'))
    structOutput.eegBaseline = preprocessedBaselineData.eeg;
    structOutput.eegThinkingPeriod = preprocessedThinkingData.eeg; 
end
if (isfield(preprocessedBaselineData,'eog'))
    structOutput.eogBaseline = preprocessedBaselineData.eog;
    structOutput.eogThinkingPeriod = preprocessedThinkingData.eog; 
    
end
if (isfield(preprocessedBaselineData,'emg'))
    structOutput.emgBaseline = preprocessedBaselineData.emg;
    structOutput.emgThinkingPeriod = preprocessedThinkingData.emg;
    
end

structOutput.questionLabels = questionLabels;
...
%% Giovanni reshaping output finish
