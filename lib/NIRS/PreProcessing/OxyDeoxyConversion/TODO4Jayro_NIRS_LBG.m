function [od_thinking,od_baseline] = TODO4Jayro_NIRS_LBG(wl_thinking, wl_baseline,fs,baselineReference)
...
for currentTrial = 1 : size(wl_thinking,3)
    ...
    switch baselineReference
        case 'self'
            ...
            [convertedDataBaseline] = GIOVANNI_NIRS_LBG(wl_baseline, wl_baseline,fs,'baseline');
            [convertedDataThinking] = GIOVANNI_NIRS_LBG(wl_thinking, wl_thinking,fs,'baseline');
            convertedData.baselineHbo = convertedDataBaseline.baselineHbo;
            convertedData.thinkingHbo = convertedDataThinking.thinkingHbo;
            convertedData.baselineHbr = convertedDataBaseline.baselineHbr;
            convertedData.thinkingHbr = convertedDataThinking.thinkingHbr;
