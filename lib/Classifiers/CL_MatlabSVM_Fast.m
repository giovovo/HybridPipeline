function [X, Y] = CL_MatlabSVM_Fast(mode, varargin)
% CL_MATLABSVM_FAST Build a support vector machine using the Matlab's
% function fitcsvm, or predict the labels using the function predict.
%   [MDL,ACC] = CL_MATLABSVM_FAST('classification',FEATURES,LABELS) returns
%   the SVM model and its accuracy. The function uses the default
%   parameters.
%
